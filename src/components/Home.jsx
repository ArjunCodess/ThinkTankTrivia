        ...
        <section className='lg:w-9/12 md:w-[90%] mx-auto mt-12 flex flex-col md:flex-row px-8 justify-between items-center md:justify-center'>
            <div className='md:w-1/2 w-full'>
                ...
                <div className='text-lg font-medium block'>
                    <Link to="/quiz"><button className='border-2 border-blue-700 bg-blue-700 px-6 py-2 text-white rounded-lg hover:tracking-widest transition-all duration-300'>View Catalog</button></Link>
                    <Link to="/about"><button className='bg-white px-6 py-2 text-blue-700 border-2 border-blue-700 rounded-lg ml-3 hover:tracking-widest transition-all duration-300'><a href="/about"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 inline-block mr-1">
                            <path strokeLinecap="round" strokeLinejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                        </svg>About Us</a></button></Link>
                </div>
            </div>
